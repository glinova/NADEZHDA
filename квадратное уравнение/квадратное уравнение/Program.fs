...
//let pr1  = 2*2
//let pr _ = MessageBox.Show (Convert.ToString(2*2),"умножение")|>ignore
...
//let pr1 =  
 //   if discrim > 0 then 
//let pr _ = MessageBox.Show ( - ( ( ( (Convert.ToDouble(textBox2.Text ) ) + sqrt discrim ) / (2.0 * (Convert.ToDouble(textBox1.Text) ) ) ) ) |> ignore
//let _ = ThisButton.Click.Add(pr) 
